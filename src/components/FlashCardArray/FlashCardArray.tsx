                    ...
                    {controls && (
                        <button onClick={() => shuffleCards()}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className="bi bi-shuffle" viewBox="0 0 16 16">
                                <path
                                    fillRule="evenodd"
                                    d="M0 3.5A.5.5 0 0 1 .5 3H1c2.202 0 3.827 1.24 4.874 2.418.49.552.865 1.102 1.126 1.582.261-.48.636-1.03 1.126-1.582C9.673 4.24 11.298 3 13.5 3H14a.5.5 0 0 1 0 1h-.5c-1.798 0-3.173 1.01-4.126 2.082-.457.514-.823 1.038-1.08 1.502.257.464.623.988 1.08 1.502C10.327 10.99 11.702 12 13.5 12H14a.5.5 0 0 1 0 1h-.5c-2.202 0-3.827-1.24-4.874-2.418-.49-.552-.865-1.102-1.126-1.582-.261.48-.636 1.03-1.126 1.582C4.827 11.76 3.202 13 1 13H.5a.5.5 0 0 1-.5-.5V10a.5.5 0 0 1 1 0v2.5a.5.5 0 0 1 .5.5H1c1.798 0 3.173-1.01 4.126-2.082A9.6 9.6 0 0 0 6.444 8a9.6 9.6 0 0 0-1.317-1.918C4.172 5.01 2.796 4 1 4H.5a.5.5 0 0 1-.5-.5V1a.5.5 0 0 1 1 0v2.5a.5.5 0 0 1-.5.5H1c1.798 0 3.173-1.01 4.126-2.082A9.6 9.6 0 0 0 6.444 8a9.6 9.6 0 0 0-1.317 1.918C4.172 12.99 2.796 14 1 14H.5a.5.5 0 0 1-.5-.5"
                                />
